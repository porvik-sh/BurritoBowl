...
const Philosphy = () => {
  return (
    <section
      id="#Philosphypage" className="w-full h-[100vh] py-10 items-center justify-center md:p-0 text-center lg:gap-5 gap-5 md:flex">
      {" "}
      <div className="flex flex-col items-center justify-center space-y-10 md:space-y-3">
        ...
        <div className="flex items-center gap-2 font-bold text-center">
          <hr className="w-[70px]" />
          <p id="job-title" className="text-xs text-black">BurritoBowl Philosphy</p>
          <hr className="w-[70px]" />
        </div>
